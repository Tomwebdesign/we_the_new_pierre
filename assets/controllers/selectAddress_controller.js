  ...
  connect() {
    this.element.querySelectorAll(".dropdown-item").forEach((btn) => {
      btn.addEventListener("click", (e) => {
        ...
        this.element.querySelector("#address_address").value =
          e.currentTarget.dataset.address;

        this.element.querySelector("#address_zipCode").value =
          e.currentTarget.dataset.zipCode;

        this.element.querySelector("#address_city").value =
